...
| **P2-G — Feature analytics** | **Ledger** `StudioFeatureActivationEvent`: `20260409100000`; `20260409110000` checkout **upsert**; `20260409120000` **partial unique** `(feature_id, stripe_subscription_id)` for `stripe_subscription_ended` + app ignores duplicate insert. Analytics tab + CSV + audit + lifecycle + ledger charts. **Still open:** cohort churn. | **Done (v1–v5 partial)** |
