...
const studioFieldControl =
  "min-h-11 w-full rounded-xl border border-stone-200/90 bg-white px-3.5 py-2 text-base text-stone-900 shadow-[0_1px_2px_rgba(28,25,23,0.04)] transition placeholder:text-stone-400 focus:border-stone-400 focus:outline-none focus:ring-2 focus:ring-stone-900/10";
...
export const studioUi = {
  buttonPrimary:
    "inline-flex min-h-11 w-full sm:w-auto items-center justify-center rounded-full bg-stone-900 px-6 py-2.5 text-sm font-medium text-white shadow-[0_1px_2px_rgba(0,0,0,0.06)] transition hover:bg-stone-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-900 disabled:pointer-events-none disabled:opacity-45",

  buttonSecondary:
    "inline-flex min-h-11 w-full sm:w-auto items-center justify-center rounded-full border border-stone-200 bg-white px-6 py-2.5 text-sm font-medium text-stone-800 transition hover:border-stone-300 hover:bg-stone-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-400",

  buttonGhost:
    "inline-flex min-h-11 items-center justify-center rounded-lg px-3 text-sm font-medium text-stone-600 transition hover:bg-stone-100 hover:text-stone-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-400",
  ...
  chipOn: "bg-stone-900 text-white",
  ...
  chipSmOn: "bg-stone-800 text-white",

  label: "block text-sm font-medium text-stone-700",
  helper: "text-sm text-stone-500",

  card: "rounded-3xl border border-stone-200/80 bg-white p-5 shadow-[0_2px_24px_rgba(28,25,23,0.04)] sm:p-6",
  ...
  tile:
    "group block overflow-hidden rounded-3xl border border-stone-200/80 bg-white shadow-[0_1px_3px_rgba(28,25,23,0.05)] transition hover:border-stone-300 hover:shadow-[0_8px_30px_rgba(28,25,23,0.06)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-400",
