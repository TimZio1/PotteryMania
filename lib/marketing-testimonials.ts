/** Honest pre-launch proof points used on marketing surfaces. */
export const EARLY_ACCESS_PROOF = {
  eyebrow: "Early access",
  headline: "Built with early-stage studio feedback, not fake case studies.",
  body:
