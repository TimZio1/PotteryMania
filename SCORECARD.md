...
| KPI | Weight | Current | Target | Evidence |
|---|---:|---:|---:|---|
| Top-10 customer journey completion | 25% | 80% (8/10 evidenced) | 100% | `qa/evidence/ux/customer-journeys.md` |
| Top-10 vendor journey completion | 25% | 50% (5/10 evidenced) | 100% | `qa/evidence/ux/studio-journeys.md` |
| Top-10 hyperadmin journey completion | 20% | 40% (4/10 evidenced) | 100% | `qa/evidence/ux/hyperadmin-journeys.md` |
| Accessibility baseline pass | 15% | 0% (dedicated Axe/Lighthouse run pending) | 100% | `qa/evidence/ux/accessibility-report-2026-04-09.md` |
...
| Financial reconciliation accuracy | 25% | BLOCKED (`DATABASE_URL` currently uses `prisma+postgres://`; direct `postgresql://` required for reconciliation script) | 100% | `qa/evidence/logic/reconciliation-report.md` |
...
| Orphan/consistency checks | 10% | BLOCKED (direct DB checks require `postgresql://`, current env uses `prisma+postgres://`) | 0 issues | `qa/evidence/logic/db-consistency-checks.md` |
...
| UX/UI | 70 | TBD | TBD | FAIL (journey/accessibility evidence missing) |
...
- Financial reconciliation remains blocked until direct `postgresql://` DB connectivity is available.
