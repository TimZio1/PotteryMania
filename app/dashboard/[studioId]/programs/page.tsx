...
export async function generateMetadata({ params }: Pick<Props, "params">): Promise<Metadata> {
  ...
  return dashboardStudioMeta(studioId, "Programs", "programs", "All your workshops, sessions, and experiences.");
}
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className={ui.overline}>Programs</p>
          <h1 className="mt-1 text-2xl font-semibold text-[var(--foreground)]">All programs</h1>
          <p className="mt-2 max-w-xl text-sm text-[var(--muted)]">
            Overview of your classes, workshops, and experiences. Edit details inline, or open the planner to manage schedules and generate bookable slots.
          </p>
        </div>
