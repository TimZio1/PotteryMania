...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return dashboardFlatMeta(studioId, "Class planner", "experiences", "Schedule rules, slot generation, and studio closed days.");
}
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 px-4 py-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link href={`/dashboard/${studioId}/classes`} className={ui.buttonSecondary}>
          ← Back to classes
        </Link>
      </div>
