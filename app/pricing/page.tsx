...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Simple plans from €19 a month. Sell your work, take class bookings, or do both — in one system.",
  path: "/pricing",
});
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {STUDIO_PLANS.map((plan) => (
            ...
            >
              ...
              >
                {plan.recommended ? "Create your studio" : `Choose ${plan.name}`}
              </Link>
            </article>
          ))}
        </div>
            ...
            <table className="w-full min-w-[640px] border-collapse text-left text-sm">
              <thead>
                <tr className="border-b border-[var(--border)] bg-[var(--surface-elevated)]">
                  <th className="px-4 py-3 font-semibold text-[var(--foreground)]">What’s included</th>
                  {STUDIO_PLANS.map((p) => (
